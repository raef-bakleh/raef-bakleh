  ...
  return (
    <div>
        ...
        <div className={classes.section}>
          <div className={classes.container}>
            ...
            <p className={classes.paragraph}>
              ...
              produce high standards of work. <br /> I am an excellent team
              worker and am able to take instructions from all levels and build
              up good working relationships with all colleagues. <br /> I am
                    ...
                    <tr className={classes.tableTr}>
                      ...
                      <th
                        ...
                        style={{
                          ...
                          textDecoration:
                            "underline 1px rgba(255, 255, 255, 0.2)",
      ...
      {!props.language && (
        <div className={classes.section}>
          <div className={classes.container}>
            <h3 className={classes.head}>Einführung</h3>
            <h1 className={classes.introTop}>Über mich</h1>
            <div className={classes.line}></div>
            <p className={classes.paragraph}>
              A hungry to learn informatics student. <br /> I am a punctual and
              motivated individual who is able to work in a busy environment and
              ...
              <div className={classes.aboutLeft}>
                <table className={classes.table}>
                  <tbody className={classes.tableBody}>
                    ...
                    <tr className={classes.tableTr}>
                      <th className={classes.tableThFirst}>alter</th>
                      <th className={classes.tableThSeconde}>25</th>
                    </tr>
                    <tr className={classes.tableTr}>
                      <th className={classes.tableThFirst}>geburtsdatum</th>
                      <th className={classes.tableThSeconde}>
                        {" "}
                        1st January 1997
                      </th>
                    ...
                    <tr className={classes.tableTr}>
                      <th className={classes.tableThFirst}>nummer</th>
                      <th
                        className={classes.tableThSeconde}
                        onMouseEnter={handleMouseEnterPhone}
                        onMouseLeave={handleMouseLeaverPhone}
